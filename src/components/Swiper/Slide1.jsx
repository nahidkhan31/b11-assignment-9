...
const Slide1 = () => {
  return (
    <div className="container mx-auto my-10 align-baseline">
      <div className="bg-[url('https://i.ibb.co.com/9HL8Nvm5/images-1.jpg')] rounded-2xl bg-no-repeat bg-cover bg-center w-[600px] h-[600px] mx-auto flex items-center justify-center px-4 md:rounded-2xl">
